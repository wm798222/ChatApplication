 ...
 *
 */
public interface IImageData extends IChatRoomMsg {
	/**
	...
	public static IDataPacketID GetID() {
		return DataPacketIDFactory.Singleton.makeID(IImageData.class);   // DataPacketIDFactory.Singleton is an instance of an IDataPacketIDFactory
	}
